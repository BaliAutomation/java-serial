...
public class Zystem
{
    ...
    /**
     * Constructor.
     * Mode is taken from the java system property "ac.bali.serial.log.mode". The available values are :<ul>
    ...
    public Zystem()
        throws UnSupportedLoggerException
    {
        String s = System.getProperty( "ac.bali.serial.log.mode" );
        if( s != null )
        {
    ...
    public void startLogger( String t )
        throws UnSupportedLoggerException
    {
        target = t;
    /*
    ...
    */
    ...
    public boolean report( String s )
    {
        ...
        {
            java.util.logging.Logger.getLogger( "ac.bali.serial" ).fine( s );
            return ( true );
        }
        return ( false );
    }
