    ...
    implements CommDriver
{
    ...
    private final static boolean noVersionOutput = "true".equals( System.getProperty( "ac.bali.serial.NoVersionOutput" ) );
...
*/
    ...
    */
    ...
    /*
     * Register ports specified in the file "ac.bali.serial.properties"
     * Key system properties:
     *                   ac.bali.serial.SerialPorts
     *             ac.bali.serial.ParallelPorts
     *
     * Tested only with sun jdk1.3
     * The file ac.bali.serial.properties must reside in the java extension dir
     *
     * Example: /usr/local/java/jre/lib/ext/ac.bali.serial.properties
     *
     * The file contains the following key properties:
     *
     *  ac.bali.serial.SerialPorts=/dev/ttyS0:/dev/ttyS1:
     *  ac.bali.serial.ParallelPorts=/dev/lp0:
     *
     */
    ...
    private boolean registerSpecifiedPorts( int PortType )
    {
        ...
        try
        {
            ...
            FileInputStream rxtx_prop = new FileInputStream( ext_dir + "ac.bali.serial.properties" );
        ...
        catch( Exception e )
        {
            if( debug )
            {
                System.out.println( "The file: ac.bali.serial.properties doesn't exists." );
        ...
        {
        case CommPortIdentifier.PORT_SERIAL:
            val = System.getProperty( "ac.bali.serial.SerialPorts" );
            break;

        case CommPortIdentifier.PORT_PARALLEL:
            val = System.getProperty( "ac.bali.serial.ParallelPorts" );
            break;
        default:
            if( debug )
            {
                System.out
                    .println( "unknown port type " + PortType + " passed to RXTXCommDriver.registerSpecifiedPorts()" );
            }
        }
    ...
    */
        ...
        case CommPortIdentifier.PORT_SERIAL:
            ...
            */
            ...
            else if( osName.toLowerCase().contains( "qnx" ) )
            {
                String[] Temp = {
                    "ser"
                };
            ...
            else
            {
                ...
                {
                    System.out
                        .println( "No valid prefixes for serial ports have been entered for " + osName + " in RXTXCommDriver.java.  This may just be a typo in the method registerScanPorts()." );
                }
            }
            break;
        ...
        default:
            ...
            {
                System.out
                    .println( "Unknown PortType " + PortType + " passed to RXTXCommDriver.registerScannedPorts()" );
            }
        }
